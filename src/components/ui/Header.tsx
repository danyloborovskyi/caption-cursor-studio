              ...
              >
                ...
                <div>
                  <h1 className="text-base sm:text-xl font-semibold text-white tracking-tight">
                    ...
                    <span className="sm:hidden">Caption Studio</span>
                  </h1>
                  <p className="text-xs sm:text-sm text-white/70 font-light hidden sm:block">
              ...
              {!isAuthenticated ? (
                <>
                  <Button
                    ...
                    variant="secondary"
                    size="sm"
                    className="px-3 sm:px-5 text-xs sm:text-sm"
                  >
                    Login
                  </Button>
                  <Button
          ...
          <div className="md:hidden border-t border-white/10">
            ...
            <div className="px-6 py-4 border-t border-white/10">
              ...
              <button
                ...
                className="w-full px-4 py-3 text-left text-sm text-white hover:bg-white/10 rounded-lg transition-colors flex items-center gap-2"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
