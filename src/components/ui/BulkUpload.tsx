...
export const BulkUpload: React.FC<BulkUploadProps> = ({
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          <button
            ...
            className={`flex-1 px-3 sm:px-4 py-3 rounded-lg text-sm font-medium transition-all cursor-pointer ${
              tagStyle === "neutral"
      ...
      <div
        className={`
          relative border-2 border-dashed rounded-lg p-4 sm:p-6 text-center transition-colors mb-4
      ...
      >
        ...
        <div className="space-y-2 sm:space-y-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-white/60">or click to select files</p>
          </div>
          <p className="text-xs text-white/50">
            <span className="hidden sm:inline">Supports: JPG, PNG, GIF, WebP (max 10MB each) • </span>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-2 sm:gap-3">
            {!isLoading && !isWaitingForAnalysis && (
              <>
                ...
                <Button onClick={clearAll} variant="outline" className="px-4 sm:px-6 w-full sm:w-auto">
                  Clear All
                </Button>
              </>
            )}
      ...
      {/* Success Message */}
      {successMessage && (
        <div className="p-3 sm:p-4 glass rounded-lg mb-6 border border-green-500/30">
          <div className="flex items-start space-x-2 sm:space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs sm:text-sm text-white/70 mt-1 break-words">{successMessage}</p>
              {isWaitingForAnalysis ? (
                <div className="flex items-center gap-2 mt-2">
                  <div className="animate-spin rounded-full h-3 w-3 border-b-2 border-blue-400 flex-shrink-0"></div>
                  <p className="text-xs text-white/50">
